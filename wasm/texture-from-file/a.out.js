...
Module['FS_createPath']('/', 'files', true, true);
 ...
 loadPackage({"files": [{"audio": 0, "start": 0, "crunched": 0, "end": 19835, "filename": "/files/sky256.jpg"}], "remote_package_size": 19835, "package_uuid": "a0c3ce6c-a2c5-480d-b330-36a25013406d"});
...
var ASM_CONSTS = [function($0) { console.log("wasm:",Pointer_stringify($0)); }];
...
Module['wasmTableSize'] = 408;

Module['wasmMaxTableSize'] = 408;
...
var real__wasm_init = asm["_wasm_init"]; asm["_wasm_init"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__wasm_init.apply(null, arguments);
};

var real__wasm_render = asm["_wasm_render"]; asm["_wasm_render"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__wasm_render.apply(null, arguments);
};
...
var _wasm_init = Module["_wasm_init"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_wasm_init"].apply(null, arguments) };
var _wasm_render = Module["_wasm_render"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_wasm_render"].apply(null, arguments) };
